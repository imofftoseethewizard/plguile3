...
handling for arrays, composite types, records, etc is added. ChatGPT
was only modestly helpful here, and perhaps that's a measure of how
complex or esoteric a subject is.
